...
public abstract class ApiTest implements Closeable {
    ...
    public <T> ApiResponse<T> httpGet(String path, Class<T> responseType) throws IOException {
    ...
    public <T> ApiResponse<T> httpPost(String path, String contentType, String payload, Class<T> responseType) throws IOException {
