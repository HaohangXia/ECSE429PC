...
public class ApiTodosTest extends ApiTest {
    ...
    public void testGetTodos() throws IOException {
        ...
        Assert.assertEquals("Elements count is not 2", 8, todos.getTodos().size());
    ...
    public void testPostTodosNotEmpty(String contentType, String payload, String title) throws IOException {
